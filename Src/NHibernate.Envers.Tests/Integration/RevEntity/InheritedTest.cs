...
namespace NHibernate.Envers.Tests.Integration.RevEntity
{
	public partial class InheritedTest : TestBase
	{
		...
		protected override IEnumerable<string> Mappings
		{
			get
			{
				return new[]{"Entities.Mapping.hbm.xml", "Entities.RevEntity.InheritedRevEntity.hbm.xml"};
			}
		}
		...
		public void VerifyFindRevision()
		{
			...
			var rev2timestamp = ((InheritedRevEntity)AuditReader().FindRevision(2)).CustomTimestamp;
