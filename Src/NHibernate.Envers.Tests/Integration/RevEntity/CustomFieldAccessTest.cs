...
{
	public partial class CustomFieldAccessTest : TestBase
	{
		private int id;
		...
		public CustomFieldAccessTest(AuditStrategyForTest strategyType) : base(strategyType)
		{
		}
		...
		protected override IEnumerable<string> Mappings
		{
			get
			{
				return new[] { "Entities.Mapping.hbm.xml", "Entities.RevEntity.CustomRevEntityFieldAccess.hbm.xml" };
			}
		}
		...
		{
			var rev1timestamp = AuditReader().FindRevision<CustomRevEntityField>(1).CustomTimestamp;
