...
namespace NHibernate.Envers.Tests.Integration.SuperClass.AuditAtMethodSuperclassLevel.AuditMethodSubclass
{
	public class MappedSubclassingMethodAuditedTest : TestBase
	{
		...
		public MappedSubclassingMethodAuditedTest(string strategyType) : base(strategyType)
		{
		}
		...
		protected override IEnumerable<string> Mappings
		{
			get
			{
				return new[]
				       	{
				       		"Integration.SuperClass.AuditAtMethodSuperclassLevel.AuditMethodSubclass.Mapping.hbm.xml",
				       		"Integration.SuperClass.AuditAtMethodSuperclassLevel.Mapping.hbm.xml"
				       	};
			}
		}
	}
