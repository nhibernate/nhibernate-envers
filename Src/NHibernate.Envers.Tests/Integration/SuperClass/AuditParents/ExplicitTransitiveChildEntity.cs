...
{
	[Audited(AuditParents = new[] { typeof(TransitiveParentEntity) })]
	public class ExplicitTransitiveChildEntity : TransitiveParentEntity
	{
		public virtual string Child { get; set; }

		public override bool Equals(object obj)
		{
			var casted = obj as ExplicitTransitiveChildEntity;
			if (casted == null)
				return false;
			if (!base.Equals(obj))
				return false;
