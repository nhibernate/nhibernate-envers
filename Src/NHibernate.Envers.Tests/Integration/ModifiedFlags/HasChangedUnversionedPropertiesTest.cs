...
{
	public class HasChangedUnversionedPropertiesTest : AbstractModifiedFlagsEntityTest
	{
		private int id;

		public HasChangedUnversionedPropertiesTest(string strategyType) : base(strategyType)
		{
		}
