...
namespace NHibernate.Envers.Compatibility
{
    ...
    public interface ISortedSet<E> : ISet<E> {
        /**
         ...
         */
        ISortedSet<E> SubSet(E fromElement, E toElement);
         ...
         *         bounds of the range
         */
        ISortedSet<E> HeadSet(E toElement);
         ...
         *         bounds of the range
         */
        ISortedSet<E> TailSet(E fromElement);
